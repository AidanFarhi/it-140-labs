...
a sentence using the input values as shown in the example below. The program 
...
# get input text from standard input
input_text = input()

# keep looping and printing result to standard output until 'quit' is recieved from standard input
while 'quit' not in input_text:
    word, number = input_text.split(' ')
